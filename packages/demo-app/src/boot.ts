...
export default (): ServiceConfig => {
    ...
    const serviceConfig = services({
        ...
        serviceId: 'orbstation-demo-app',
        logId: 'orbstation-demo-app',
    })
    ...
    const extService = ServiceService.use(ExtensionService)
    extService.preloadSync(ServiceService.use(HookService))
